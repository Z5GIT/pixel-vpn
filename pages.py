...
<div class="wrap">
  <div class="card">
    ...
    <div class="hint">
      ...
      <span class="hint-val" onclick="document.getElementById('pw').value='pixelgit';document.getElementById('pw').focus()">pixelgit</span>
    </div>
    <form id="form">
      <div class="field">
...
<div class="wrap">
  ...
  <div class="footer">پشتیبانی: <a href="https://t.me/pixelgit" target="_blank">@pixelgit</a> · X4G v9.5</div>
</div>
<script>
