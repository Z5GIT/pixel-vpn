...
* 📣 ارسال کانفیگ‌های ۱ تا ۱۰۰ گیگ به کانال تنظیم‌شده بدون سقف تعداد ارسال
* 🎁 دریافت روزانه یک کانفیگ رایگان ۱ گیگ برای کاربران عادی (`/free`)

## ⚙️ متغیرهای محیطی

| متغیر | توضیح | پیش‌فرض |
|---|---|---|
| `ADMIN_PASSWORD` | رمز عبور ورود به داشبورد وب | `pixelgit` |
...
X4G · پشتیبانی: [@pixelgit](https://t.me/pixelgit)
